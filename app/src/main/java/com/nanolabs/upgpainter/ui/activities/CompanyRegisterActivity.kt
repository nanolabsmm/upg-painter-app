...
import kotlinx.android.synthetic.main.activity_company_register.btnContinue
...
class CompanyRegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spcNrcRegion.adapter = RegionStateNumberAdapter
...
//        NrcNameListAdapter?.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line)
        NrcNameListAdapter = ArrayAdapter(applicationContext,android.R.layout.simple_spinner_item,NrcNameList)
        NrcNameListAdapter?.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line)
        spcNrcNumber.adapter = NrcNameListAdapter


        spcNrcRegion.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
        ...
        spcNrcState.onItemSelectedListener =  object :AdapterView.OnItemSelectedListener{
            override fun onNothingSelected(parent: AdapterView<*>?) {
                TODO("Not yet implemented")
            }
        ...
        spcNrcNumber.onItemSelectedListener = object :AdapterView.OnItemSelectedListener{
            override fun onNothingSelected(parent: AdapterView<*>?) {
                TODO("Not yet implemented")
            }
        ...
        spcRegion.adapter = spRegionAdapter

       spcRegion.onItemSelectedListener = object :AdapterView.OnItemSelectedListener{
           override fun onNothingSelected(parent: AdapterView<*>?) {
               TODO("Not yet implemented")
           }
        ...
        spcCity.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
            override fun onNothingSelected(parent: AdapterView<*>?) {
    ...
    fun selectNRC(list:ArrayList<String>){
        ...
        spcNrcState.adapter = jobAdapter
    }
